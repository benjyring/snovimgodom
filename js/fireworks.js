...
const fireworksCtx = canvas.getContext('2d');
const PI2 = Math.PI * 2;
...
const clear = () => {
	...
	fireworksCtx.fillStyle = 'hsla(0, 0%, 0%, 0.5)';
	fireworksCtx.fillRect(0, 0, fireworksCtx.canvas.width, fireworksCtx.canvas.height);
...
const loop = () => {
	...
	particles.forEach((particle, index) => {
		...
		fireworksCtx.fillStyle = fill;
		fireworksCtx.arc(particle.x, particle.y, particle.radius, 0, PI2);
		fireworksCtx.fill();
